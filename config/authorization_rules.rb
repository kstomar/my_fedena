authorization do
  ...
  role :examination_control do
    ...
    has_permission_on [:exam],
      ...
      :consolidated_exam_report_exam_group_pdf,
      :consolidated_exam_report_exam_group_xls,
      :consolidated_exam_report_exam_group
    ]
